...
## 使用方法
<code>wget -O crack_bt_panel_pro.sh https://raw.githubusercontent.com/luguo124/Crack_BT_Panel/master/crack_bt_panel_pro.sh && bash crack_bt_panel_pro.sh</code>
